...
const ApplyApplicantModal = ({ open, handleClose, handleSubmit, setCandidateData, candidateData, handleInput }) => {
    return (
        <Modal
            open={open}
            onClose={handleClose}
                ...
                >
                    <Grid container marginLeft="0.1rem" marginBottom="2rem" spacing={3}>
                        ...
                        <Grid item md={12} sm={12} xs={12}>
                            ...
                            <CountrySelect
                                setApplicantData={setCandidateData}
                                applicantData={setCandidateData}
                                type="country"
                            />
                        </Grid>
                        ...
                        <Grid container sx={{ display: 'flex', alignItems: 'center' }}>
                            <Button variant="outlined" component="label" sx={ButtonStyles}>
                                ...
                                <Input
                                    ...
                                    type="file"
                                    sx={{ display: 'none' }}
                                    onChange={(e) => setCandidateData({ ...candidateData, cv_file: e.target.files[0] })}
                                    required
                                />
                            </Button>
                            {candidateData.cv_file ? (
                                <StyledTypography fontSize={16} fontWeight="300" marginLeft={3}>
                                    {candidateData.cv_file.name}
                                </StyledTypography>
                            ) : (
                                <StyledTypography fontSize={16} fontWeight="300" marginLeft={3}>
                                    No file chosen
                    ...
                    <Grid item md={12} sm={12} xs={12} margin="1rem">
                        <InputLabel htmlFor="icon-button-file" style={{ display: 'flex', alignItems: 'center' }}>
                            <Input
                                ...
                                sx={{ display: 'none' }}
                                onChange={(e) =>
                                    setCandidateData({ ...candidateData, motivation_letter_file: e.target.files[0] })
                                }
                            />
...
export default ApplyApplicantModal;